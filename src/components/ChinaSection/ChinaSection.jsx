...
const ChinaSection = () => {
  ...
  return (
    <div className="relative sm:h-[30vw] sm:w-full bg-china-section bg-no-repeat sm:bg-center bg-cover flex justify-end items-center p-14 sm:p-0">
      <div className="flex flex-col sm:w-[49%] sm:pr-[4vw]">
