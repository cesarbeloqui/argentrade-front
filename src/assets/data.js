const locales = {
  es: {
    ...
    queHacemosSection: {
      titulo: "¿Qué hacemos?",
      contenido: `Somos especialistas en la gestión y servicios de importación a nivel mundial, enfocados en el mercado asiático.
      Contamos con la experiencia, talento y herramientas necesarias para importar cualquier tipo de producto.
      Nos convertimos en el departamento de Comercio Exterior de tu empresa para que mejoren su rentabilidad, competitividad y costos y sigan enfocados en vender más y desarrollar nuevos negocios.`,
      items: [
        {
          id: 1,
