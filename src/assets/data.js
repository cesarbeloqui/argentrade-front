const locales = {
  es: {
    ...
    chinaSection: {
      ...
      contenido: `{r}Servicio de triangulación:{/r} Gestionamos el envío de (pedidos/mercadería/productos) de China hacia empresas ubicadas en cualquier parte del mundo…`,
    },
...
`,
    ...
    chinaSection: {
      ...
      contenido: `{r}Triangulation service{/r}: We manage the shipment of (orders/merchandise/products) from China to companies located in any part of the world…`,
    },
    serviciosYProductosSection: {
